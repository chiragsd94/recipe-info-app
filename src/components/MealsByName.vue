<template>
   <div class="mb-4 p-4">
    <form class="flex flex-row" @submit.prevent="handleSubmit">
  <input id="input1" class="w-full border border-lg border-yellow-500 px-4 py-2 rounded-full focus:border-cyan-500 focus:shadow-lg focus:border-lg focus:border-cyan-500 focus:shadow-cyan-500 mr-2 ml-2"
   type="text" 
   placeholder="Search Meal by name..."
   v-model="mealName" />
   <button class="bg-cyan-500 shadow-lg shadow-cyan-700 rounded m-auto p-2">search</button>
</form>
